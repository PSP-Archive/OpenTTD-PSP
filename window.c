/* $Id: window.c 10467 2007-07-07 18:01:26Z rubidium $ */
...
#else
         // Due to psp screen nature and ability to move windows pressing
         // square over the window instead of title bar, allow to leave screen
         nx = clamp(nx, -150 - t->right, _screen.width - -150 - t->left);
         ny = clamp(ny, -150, _screen.height - -150);
#endif
