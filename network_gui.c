/* $Id: network_gui.c 10841 2007-08-10 17:53:12Z rubidium $ */
...
#if defined(PSP)
#include <psppower.h>
extern int freq_level;
extern uint16 psp_frequencies[3][3];
#endif
...
static const Widget _chat_window_widgets[] = {
{   WWT_CLOSEBOX, RESIZE_NONE, 14,   0,  10,  0, 13, STR_00C5,         STR_018B_CLOSE_WINDOW},
{      WWT_PANEL, RESIZE_NONE, 14,  11, 478,  0, 13, 0x0,              STR_NULL}, // background
{      WWT_PANEL, RESIZE_NONE, 14,  75, 416,  1, 12, 0x0,              STR_NULL}, // text box
{ WWT_PUSHTXTBTN, RESIZE_NONE, 14, 417, 478,  1, 12, STR_NETWORK_SEND, STR_NULL}, // send button
{   WIDGETS_END},
};
#endif
...
#else
    WDP_CENTER, -26, 479, 14, // x, y, width, height
#endif
