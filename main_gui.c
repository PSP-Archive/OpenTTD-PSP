/* $Id: main_gui.c 11074 2007-09-09 20:52:54Z rubidium $ */
...
static void ToolbarTrainClick(Window *w)
{
	...
	PopupMainPlayerToolbMenu(w, 260, 13, dis);
}
...
static void ToolbarRoadClick(Window *w)
{
	...
	PopupMainPlayerToolbMenu(w, 280, 14, dis);
}
...
static void ToolbarShipClick(Window *w)
{
	...
	PopupMainPlayerToolbMenu(w, 300, 15, dis);
}
...
static void ToolbarAirClick(Window *w)
{
	...
	PopupMainPlayerToolbMenu(w, 320, 16, dis);
}
...
{     WWT_IMGBTN,   RESIZE_NONE,    14,     0,    20,     0,    19, SPR_IMG_PAUSE,           STR_0171_PAUSE_GAME},
{     WWT_IMGBTN,   RESIZE_NONE,    14,    20,    40,     0,    19, SPR_IMG_FASTFORWARD,     STR_FAST_FORWARD},
{     WWT_IMGBTN,   RESIZE_NONE,    14,    40,    60,     0,    19, SPR_IMG_SETTINGS,        STR_0187_OPTIONS},
{   WWT_IMGBTN_2,   RESIZE_NONE,    14,    60,    80,     0,    19, SPR_IMG_SAVE,            STR_0172_SAVE_GAME_ABANDON_GAME},

{     WWT_IMGBTN,   RESIZE_NONE,    14,    80,   100,     0,    19, SPR_IMG_SMALLMAP,        STR_0174_DISPLAY_MAP},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   100,   120,     0,    19, SPR_IMG_TOWN,            STR_0176_DISPLAY_TOWN_DIRECTORY},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   120,   140,     0,    19, SPR_IMG_SUBSIDIES,       STR_02DC_DISPLAY_SUBSIDIES},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   140,   160,     0,    19, SPR_IMG_COMPANY_LIST,    STR_0173_DISPLAY_LIST_OF_COMPANY},

{     WWT_IMGBTN,   RESIZE_NONE,    14,   160,   180,     0,    19, SPR_IMG_COMPANY_FINANCE, STR_0177_DISPLAY_COMPANY_FINANCES},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   180,   200,     0,    19, SPR_IMG_COMPANY_GENERAL, STR_0178_DISPLAY_COMPANY_GENERAL},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   200,   220,     0,    19, SPR_IMG_GRAPHS,          STR_0179_DISPLAY_GRAPHS},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   220,   240,     0,    19, SPR_IMG_COMPANY_LEAGUE,  STR_017A_DISPLAY_COMPANY_LEAGUE},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   240,   260,     0,    19, SPR_IMG_INDUSTRY,        STR_0312_FUND_CONSTRUCTION_OF_NEW},

{     WWT_IMGBTN,   RESIZE_NONE,    14,   260,   280,     0,    19, SPR_IMG_TRAINLIST,       STR_017B_DISPLAY_LIST_OF_COMPANY},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   280,   300,     0,    19, SPR_IMG_TRUCKLIST,       STR_017C_DISPLAY_LIST_OF_COMPANY},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   300,   320,     0,    19, SPR_IMG_SHIPLIST,        STR_017D_DISPLAY_LIST_OF_COMPANY},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   320,   340,     0,    19, SPR_IMG_AIRPLANESLIST,   STR_017E_DISPLAY_LIST_OF_COMPANY},

{     WWT_IMGBTN,   RESIZE_NONE,    14,   340,   350,     0,    19, SPR_IMG_ZOOMIN,          STR_017F_ZOOM_THE_VIEW_IN},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   350,   360,     0,    19, SPR_IMG_ZOOMOUT,         STR_0180_ZOOM_THE_VIEW_OUT},

{     WWT_IMGBTN,   RESIZE_NONE,    14,   360,   380,     0,    19, SPR_IMG_BUILDRAIL,       STR_0181_BUILD_RAILROAD_TRACK},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   380,   400,     0,    19, SPR_IMG_BUILDROAD,       STR_0182_BUILD_ROADS},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   400,   420,     0,    19, SPR_IMG_BUILDWATER,      STR_0183_BUILD_SHIP_DOCKS},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   420,   440,     0,    19, SPR_IMG_BUILDAIR,        STR_0184_BUILD_AIRPORTS},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   440,   450,     0,    19, SPR_IMG_LANDSCAPING,     STR_LANDSCAPING_TOOLBAR_TIP}, // tree icon is 0x2E6

{     WWT_IMGBTN,   RESIZE_NONE,    14,   450,   460,     0,    19, SPR_IMG_MUSIC,           STR_01D4_SHOW_SOUND_MUSIC_WINDOW},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   460,   470,     0,    19, SPR_IMG_MESSAGES,        STR_0203_SHOW_LAST_MESSAGE_NEWS},
{     WWT_IMGBTN,   RESIZE_NONE,    14,   470,   479,     0,    19, SPR_IMG_QUERY,           STR_0186_LAND_BLOCK_INFORMATION},
{   WIDGETS_END},
};
#else
/* Normal Toolbar data */
...
{  WWT_IMGBTN, RESIZE_NONE, 14,  20,  40,  0, 19, SPR_IMG_FASTFORWARD, STR_FAST_FORWARD},
{  WWT_IMGBTN, RESIZE_NONE, 14,  40,  60,  0, 19, SPR_IMG_SETTINGS,    STR_0187_OPTIONS},
{WWT_IMGBTN_2, RESIZE_NONE, 14,  60,  80,  0, 19, SPR_IMG_SAVE,        STR_0297_SAVE_SCENARIO_LOAD_SCENARIO},

{   WWT_PANEL, RESIZE_NONE, 14,  80,  90,  0, 19, 0x0,                 STR_NULL},

{   WWT_PANEL, RESIZE_NONE, 14,  90, 229,  0, 19, 0x0,                 STR_NULL},
{  WWT_IMGBTN, RESIZE_NONE, 14,  93, 103,  5, 16, SPR_ARROW_DOWN,      STR_029E_MOVE_THE_STARTING_DATE},
{  WWT_IMGBTN, RESIZE_NONE, 14, 206, 216,  5, 16, SPR_ARROW_UP,        STR_029F_MOVE_THE_STARTING_DATE},

{  WWT_IMGBTN, RESIZE_NONE, 14, 226, 246,  0, 19, SPR_IMG_SMALLMAP,    STR_0175_DISPLAY_MAP_TOWN_DIRECTORY},

{  WWT_IMGBTN, RESIZE_NONE, 14, 246, 266,  0, 19, SPR_IMG_ZOOMIN,      STR_017F_ZOOM_THE_VIEW_IN},
{  WWT_IMGBTN, RESIZE_NONE, 14, 266, 286,  0, 19, SPR_IMG_ZOOMOUT,     STR_0180_ZOOM_THE_VIEW_OUT},

{  WWT_IMGBTN, RESIZE_NONE, 14, 286, 306,  0, 19, SPR_IMG_LANDSCAPING, STR_022E_LANDSCAPE_GENERATION},
{  WWT_IMGBTN, RESIZE_NONE, 14, 306, 326,  0, 19, SPR_IMG_TOWN,        STR_022F_TOWN_GENERATION},
{  WWT_IMGBTN, RESIZE_NONE, 14, 326, 346,  0, 19, SPR_IMG_INDUSTRY,    STR_0230_INDUSTRY_GENERATION},
{  WWT_IMGBTN, RESIZE_NONE, 14, 346, 366,  0, 19, SPR_IMG_BUILDROAD,   STR_0231_ROAD_CONSTRUCTION},
{  WWT_IMGBTN, RESIZE_NONE, 14, 366, 386,  0, 19, SPR_IMG_PLANTTREES,  STR_0288_PLANT_TREES},
{  WWT_IMGBTN, RESIZE_NONE, 14, 386, 406,  0, 19, SPR_IMG_SIGN,        STR_0289_PLACE_SIGN},
...
{   WWT_EMPTY, RESIZE_NONE,  0,   0,   0,  0,  0, 0x0,                 STR_NULL},
{   WWT_EMPTY, RESIZE_NONE,  0,   0,   0,  0,  0, 0x0,                 STR_NULL},
{  WWT_IMGBTN, RESIZE_NONE, 14, 410, 430,  0, 19, SPR_IMG_MUSIC,       STR_01D4_SHOW_SOUND_MUSIC_WINDOW},
{   WWT_EMPTY, RESIZE_NONE,  0,   0,   0,  0,  0, 0x0,                 STR_NULL},
{  WWT_IMGBTN, RESIZE_NONE, 14, 430, 450,  0, 19, SPR_IMG_QUERY,       STR_0186_LAND_BLOCK_INFORMATION},
{WIDGETS_END},
};
#endif
...
#else
		DrawStringCentered(159, 6, STR_00AF, 0);
#endif
...
#else
	if (!FillDrawPixelInfo(&tmp_dpi, 100, 1, 281, 11)) return true;
#endif
...
static void StatusBarWndProc(Window *w, WindowEvent *e)
{
	...
	case WE_PAINT: {
		...
		int datePos = 70;
		int moneyPos = 570;
		int statusBarPos = 320;
#else
		int datePos = 45;
		int moneyPos = 434;
		int statusBarPos = 240;
#endif
		...
		SetDParam(0, _date);
		DrawStringCentered(
			datePos, 1, (_pause || _patches.status_long_date) ? STR_00AF : STR_00AE, 0
		);
		...
		if (p != NULL) {
			...
			DrawStringCentered(moneyPos, 1, p->player_money >= 0 ? STR_0004 : STR_0005, 0);
		}

		// Draw status bar
		if (w->message.msg) { // true when saving is active
			DrawStringCentered(statusBarPos, 1, STR_SAVING_GAME, 0);
		} else if (_do_autosave) {
			DrawStringCentered(statusBarPos, 1, STR_032F_AUTOSAVE, 0);
		} else if (_pause) {
			DrawStringCentered(statusBarPos, 1, STR_0319_PAUSED, 0);
			...
			if (p != NULL) {
				...
				SetDParam(0, p->name_1);
				SetDParam(1, p->name_2);
				DrawStringCentered(statusBarPos, 1, STR_02BA, 0);
			}
		}
...
#else
static const Widget _main_status_widgets[] = {
{      WWT_PANEL,   RESIZE_NONE,    14,     1,    90,     0,    11, 0x0, STR_NULL},
{    WWT_PUSHBTN,   RESIZE_NONE,    14,    91,   388,     0,    11, 0x0, STR_02B7_SHOW_LAST_MESSAGE_OR_NEWS},
{    WWT_PUSHBTN,   RESIZE_NONE,    14,   389,   479,     0,    11, 0x0, STR_NULL},
{   WIDGETS_END},
};
#endif
