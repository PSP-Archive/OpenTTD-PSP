/* $Id: driver.c 10307 2007-06-24 18:26:50Z orudge $ */
...
#endif
#if defined(WITH_SDL) && !defined(PSP)
...
#endif
#ifdef PSP
   M("psp", "PSP Sound Driver",   &_psp_sound_driver),
#endif
